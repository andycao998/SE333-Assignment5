...
- [Unit tests w/ mocking](src/test/java/org/example/AmazonUnitTest.java)
- [Integration tests](src/test/java/org/example/AmazonIntegrationTest.java)

<h2>Continuous Integration</h2>
CI workflow through GitHub Actions that runs Checkstyle and code coverage, generating jacoco.xml and checkstyle.xml report artifacts. These artifacts can be found under the latest passing workflow run.
<br>
<br>

Workflow found [here](.github/workflows/SE333_CI.yml)
